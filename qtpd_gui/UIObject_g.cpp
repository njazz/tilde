    ...
    : UIItem(parent)
{
    ...
    _sizeBox = new SizeBoxItem(this);
    _sizeBox->hide();

//    setAttribute(Qt::WA_Hover, true);

    connect(_sizeBox, &SizeBoxItem::resizeBoxEvent, this, &UIObjectItem::resizeBox);
...
{
    PortItem* new_in = new PortItem(this);
...
{
    PortItem* new_out = new PortItem(this);
...
PortItem *UIObjectItem::inletAt(int idx)
{
...
PortItem* UIObjectItem::outletAt(int idx)
{
