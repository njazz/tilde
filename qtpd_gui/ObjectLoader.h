...
///
typedef UIObjectItem* (*cmObjectConstructor)(std::string objectData, t_canvas* pdCanvas, QGraphicsView* parent);
...
public:
    ...
    UIObjectItem* createObject(QString objectData, t_canvas* pdCanvas, QGraphicsView *parent);
};
}
