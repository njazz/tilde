...
//    connect(this->editor_, &QLineEdit::editingFinished, this, &UIClass::editorDone);
//    connect(this->editor_, &QLineEdit::textEdited, this, &UIClass::editorChanged);
